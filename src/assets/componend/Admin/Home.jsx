...
const stats = [
  { id: 1, name: 'Total Pengguna', stat: '71,897', icon: UsersIcon, change: '122', changeType: 'increase' },
            ...
            <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6">
                <div className="text-sm">
                  <a href="admin/user" className="font-medium text-indigo-600 hover:text-indigo-500">
